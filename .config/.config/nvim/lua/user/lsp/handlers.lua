...
local function lsp_keymaps(bufnr)
	...
	keymap(bufnr, "n", "<leader>lf", "<cmd>lua vim.lsp.buf.format({ async = true, timeout_ms = 5000 })<cr>", opts)
	...
	--[[ keymap(bufnr, "n", "gI", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts) ]]
	--[[ keymap(bufnr, "n", "gr", "<cmd>lua vim.lsp.buf.references()<CR>", opts) ]]
	--[[ keymap(bufnr, "n", "<leader>lf", "<cmd>lua vim.lsp.buf.format({ async = true, timeout_ms = 2000 })<cr>", opts) ]]
	--[[ keymap(bufnr, "n", "<leader>ll", "<cmd>lua vim.diagnostic.setloclist()<CR>", opts) ]]
	--[[ keymap(bufnr, "n", "<leader>lq", "<cmd>lua vim.diagnostic.setqflist()<CR>", opts) ]]
end
