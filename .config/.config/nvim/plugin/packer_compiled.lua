...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  dracula = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/dracula",
  ...
  ["nlsp-settings.nvim"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/nlsp-settings.nvim",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/typescript.nvim",
    url = "https://github.com/jose-elias-alvarez/typescript.nvim"
  },
  ["vim-easymotion"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/vim-easymotion",
    url = "https://github.com/easymotion/vim-easymotion"
  },
  ["vim-illuminate"] = {
    loaded = true,
    path = "/home/kyle/.local/share/nvim/site/pack/packer/start/vim-illuminate",
