...
awful.spawn("rclone mount --file-perms 0777 --dir-perms 0777 --daemon google-drive: /home/kyle/google-drive/")
awful.spawn("ln -sf /home/{{ lookup('env', 'USER') }}/.dotfiles/.config/.config/kitty/kitty.png /usr/lib/kitty/logo/kitty.png")
awful.spawn("ln -sf /home/{{ lookup('env', 'USER') }}/.dotfiles/.config/.config/kitty/kitty-128.png /usr/lib/kitty/logo/kitty-128.png")
